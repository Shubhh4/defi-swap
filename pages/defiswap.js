import { Input } from "@nextui-org/react";  //it's the nextui styling
...
export default function Defiswap() {
    ...
    const config = {
      apiKey: "E0Z2fuPjO1B2a9YwKFuFURWZZGlmcdwC",
...
async function swapit() {
  ...
  return (
    ...
    >
      ...
      <Card isPressable css={{backgroundColor:'#00FF00'}} onPress={swapit}>
                <Text
